...
import java.util.Scanner;
    ...
    public class delteData  {
        public static <Contact> void main(String[] args) {
            ...
            //System.out.println("First name to modify the data:");
            //String  name1=sc.next();
            //int index = con.indexOf("name1");


            System.out.println("Enter First name to delete the data:");
            String name = sc.next();
            con.remove(0);
            System.out.println("After deleting"+con);
        }
